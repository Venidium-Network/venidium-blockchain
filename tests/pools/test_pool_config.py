...
from venidium.pools.pool_config import PoolWalletConfig
from venidium.util.config import load_config, save_config, create_default_venidium_config
...
def test_pool_config():
    ...
    create_default_venidium_config(test_root, ["config.yaml"])

...
from venidium.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from venidium.plotting.manager import PlotManager
from venidium.protocols import farmer_protocol
from venidium.rpc.farmer_rpc_api import FarmerRpcApi
from venidium.rpc.farmer_rpc_client import FarmerRpcClient
from venidium.rpc.harvester_rpc_api import HarvesterRpcApi
from venidium.rpc.harvester_rpc_client import HarvesterRpcClient
...
from venidium.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xvm"), encode_puzzle_hash(new_ph_2, "xvm"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xvm"))
            ...
            assert config["farmer"]["xvm_target_address"] == encode_puzzle_hash(new_ph, "xvm")
            assert config["pool"]["xvm_target_address"] == encode_puzzle_hash(new_ph_3, "xvm")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xvm")

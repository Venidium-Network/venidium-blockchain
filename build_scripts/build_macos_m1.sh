...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Venidium-darwin-arm64/Venidium.app --platform=darwin \
...
mv Venidium-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Venidium-$VENIDIUM_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Venidium-darwin-arm64/Venidium.app Venidium-$VENIDIUM_INSTALLER_VERSION-arm64 \

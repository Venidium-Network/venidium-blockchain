...
required to run a [Timelord](https://github.com/Venidium-Network/venidium-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Venidium-Network/venidium-blockchain/blob/main/install-timelord.sh)

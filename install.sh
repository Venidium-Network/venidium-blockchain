...
echo "https://keybase.io/team/venidium_network.public"
echo ""
echo "Try the Quick Start Guide to running venidium-blockchain:"
echo "https://github.com/Venidium-Network/venidium-blockchain/wiki/Quick-Start-Guide"
echo ""

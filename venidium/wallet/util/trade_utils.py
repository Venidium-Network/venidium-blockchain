...
from venidium.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "venidium" in cc_discrepancies:
                    cc_discrepancies["venidium"] = cc_discrepancies["venidium"] + diff
                else:
                    cc_discrepancies["venidium"] = diff

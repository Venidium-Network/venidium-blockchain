...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from venidium.introducer.introducer_api import IntroducerAPI

        return IntroducerAPI
    elif type is NodeType.TIMELORD:
        from venidium.timelord.timelord_api import TimelordAPI
        ...
        from venidium.harvester.harvester_api import HarvesterAPI

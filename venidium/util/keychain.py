...
DEFAULT_USER = f"user-venidium-{CURRENT_KEY_VERSION}"  # e.g. user-venidium-1.8
DEFAULT_SERVICE = f"venidium-{DEFAULT_USER}"  # e.g. venidium-user-venidium-1.8
...
def supports_keyring_passphrase() -> bool:
    # Support can be disabled by setting VENIDIUM_PASSPHRASE_SUPPORT to 0/false
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from venidium.cmds.passphrase_funcs import prompt_for_passphrase

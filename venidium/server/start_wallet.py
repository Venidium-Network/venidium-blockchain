...
from venidium.server.start_service import run_service
from venidium.types.peer_info import PeerInfo
from venidium.util.config import load_config_cli, load_config
...
from venidium.wallet.wallet_node_api import WalletNodeAPI
...
def main() -> None:
    ...
    if local_test is True:
        ...
        config["selected_network"] = "kition"
    else:

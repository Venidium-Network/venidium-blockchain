...
from venidium.harvester.harvester import Harvester
from venidium.plotting.plot_tools import PlotInfo, parse_plot_info
from venidium.protocols import harvester_protocol
from venidium.protocols.farmer_protocol import FarmingInfo
from venidium.protocols.harvester_protocol import Plot
from venidium.protocols.protocol_message_types import ProtocolMessageTypes
from venidium.server.outbound_message import make_msg
...
from venidium.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSVenidiumConnection
    ):
        """

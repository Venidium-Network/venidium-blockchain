...
from venidium.full_node.generator import create_generator_args, setup_generator_args
from venidium.types.blockchain_format.coin import Coin
from venidium.types.blockchain_format.program import NIL
...
from venidium.util.clvm import int_from_bytes, int_to_bytes
...
from venidium.util.ints import uint32, uint64, uint16
from venidium.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see venidium/types/blockchain_format/program.py)
